...
class ApiFragment : BindingFragment<FragmentApiBinding>(FragmentApiBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tabLayout.getTabAt(EARTH)?.customView =
            layoutInflater.inflate(R.layout.activity_api_tablayout_item_earth, null)
        binding.tabLayout.getTabAt(MARS)?.customView =
            layoutInflater.inflate(R.layout.activity_api_tablayout_item_mars, null)
        binding.tabLayout.getTabAt(SYSTEM)?.customView =
            layoutInflater.inflate(R.layout.activity_api_tablayout_item_system, null)
